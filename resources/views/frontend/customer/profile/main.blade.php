                     ...
                     <div class="col-md-12">
                         ...
                         <div class="nav-align-center">
                             <ul class="nav nav-pills nav-pills-primary nav-pills-just-icons" role="tablist">
                                 <li class="nav-item">
                                     <a class="nav-link" data-toggle="tab" href="#profile" role="tablist" aria-expanded="false">
                                         <i class="now-ui-icons design_image"></i>
                                     </a>
                                 </li>
                                 <li class="nav-item">
                                     <a class="nav-link" data-toggle="tab" href="#home" role="tablist" aria-expanded="false">
                                         <i class="now-ui-icons location_world"></i>
                                     </a>
                                 </li>
                                 <li class="nav-item">
                                     <a class="nav-link active" data-toggle="tab" href="#messages" role="tablist" aria-expanded="true">
                         ...
                         <div class="tab-content gallery">
                             ...
                             <div class="tab-pane active" id="messages" role="tabpanel" aria-expanded="true">
                                 <div class="row">
                                     <div class="col-md-5 ml-auto mr-auto">
