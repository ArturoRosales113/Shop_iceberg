                    ...
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto text-center">
                            ...
                            <ul class="nav nav-pills nav-pills-danger justify-content-center" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#pill1" role="tablist" aria-expanded="true">
                                        Todos
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#pill2" role="tablist" aria-expanded="false">
                                        Mujer
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#pill3" role="tablist" aria-expanded="false">
                                        Hombre
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#pill4" role="tablist" aria-expanded="false">
                                        Unisex
                                    </a>
                                </li>
                            </ul>
                            <div class="tab-content tab-space">
                                ...
                                <div class="tab-pane" id="pill3" aria-expanded="false">
                                </div>
