        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item">
                <div class="page-header header-filter">
                    <div class="page-header-image" style="background-image: url('{{ url('img/bg2.jpg') }}');"></div>
            ...
            <div class="carousel-item active carousel-item-left">
                <div class="page-header header-filter">
                    <div class="page-header-image" style="background-image: url('{{ url('img/bg3.jpg') }}');"></div>
                    <div class="content-center">
                        <div class="container">
                            <div class="content-center">
                                <div class="row">
            ...
            <div class="carousel-item carousel-item-next carousel-item-left">
                <div class="page-header header-filter">
                    <div class="page-header-image" style="background-image: url('{{ url('img/bg1.jpg') }}');"></div>
                    <div class="content-center">
                        <div class="container">
                            <div class="content-center">
                                <div class="row">
